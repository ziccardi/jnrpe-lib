...
public class OracleSQLQueryResolver implements ISQLQueryResolver
{
    ...
    public List<ResultSetMockRow> resolveSQL(String sSQL)
    {
        ...
        if (sSQL
                .equalsIgnoreCase("select NVL(b.free,0.0),a.total,100 - trunc(NVL(b.free,0.0)/a.total * 1000) / 10 prc "
        ...
        {
            vResult.add(new ResultSetMockRowBuilder().widthValue("NVL(b.free,0.0)",
                    80).widthValue("total", 100).widthValue("prc", 20).create());
        }
        ...
        {
            vResult.add(new ResultSetMockRowBuilder().widthValue("NVL(b.free,0.0)",
                    25).widthValue("total", 100).widthValue("prc", 75).create());
        }
        ...
        {
            vResult.add(new ResultSetMockRowBuilder().widthValue("NVL(b.free,0.0)",
                    10).widthValue("total", 100).widthValue("prc", 90).create());
        }
