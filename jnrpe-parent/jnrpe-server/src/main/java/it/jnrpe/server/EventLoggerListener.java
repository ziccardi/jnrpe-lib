...
/**
 * The JNRPE Server uses this event listener to populate the
 * log files.
 * 
...
{
    private Map<String, Logger> m_mLoggers = new HashMap<String, Logger>();
...
//        if (sEventName.equals("COMMAND_INVOKED"))
//        {
//            Map<String, Object> mParams = event.getEventParams();
//            
//            logger.debug("Invoked command {} - Return Code : {} - Return Message : '{}'", new Object[]{ mParams.get("COMMAND_NAME"),
//                                                                                                        mParams.get("RETURN_CODE"),
//                                                                                                        mParams.get("RETURN_MESSAGE")
//                                                                                                        });
//            logger.trace("Arguments : {}", mParams.get("ARGS"));
//            return;
//        }
